...
cd src
python server.py
# 服务运行在 http://0.0.0.0:443
# Swagger 文档: http://localhost:443/docs
```
...
# 获取股票列表
curl "http://localhost:443/api/v1/stock/list?list_status=L"

# 查询平安银行日线
curl "http://localhost:443/api/v1/stock/daily?ts_code=000001.SZ"

# 量化基础数据包（一键获取全量）
curl -X POST "http://localhost:443/api/v1/combo/quant_basic" \
